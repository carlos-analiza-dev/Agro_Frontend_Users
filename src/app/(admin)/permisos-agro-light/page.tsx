...
import { CrearPermisoAgro } from "@/apis/permisos-clientes/accions/crear-permiso";
import { useQueryClient } from "@tanstack/react-query";
import { toast } from "react-toastify";
import { EditarPermisoAgro } from "@/apis/permisos-clientes/accions/editar-permiso";
      ...
      if (isAxiosError(error)) {
        ...
        const errorMessage = Array.isArray(messages)
          ...
          : typeof messages === "string"
            ? messages
            : "Hubo un error al ingresar el permiso";

        toast.error(errorMessage);
      } else {
        toast.error(
          "Hubo un error al momento de ingresar el permiso. Inténtalo de nuevo.",
        );
      }
    }
  };
